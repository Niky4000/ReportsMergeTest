package ru.ibs.reports.merge.test;
...
public class ActMeeReportFileExporter3Test {
	...
	public static void test() throws Exception {
		...
		byte[] byteArray = (byte[]) getReportPdfMethod.invoke(actMeeReportFileExporter3, context);
		File file = new File("/home/me/tmp/reportsPdf/report.docx");
		if (file.exists()) {
			file.delete();
		}
